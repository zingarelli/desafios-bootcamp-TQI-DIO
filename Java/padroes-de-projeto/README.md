...
## Desafio
O desafio consistiu em implementar três design patterns: Singleton, Strategy e Facade. A implementação foi feita utilizando Java puro, codificando o padrão, e também utilizando o Java Spring, para verificar como o Spring Framework facilita o desenvolvedor com os conceitos de Inversão de Controle e Injeção de Dependência. 

## Implementação em Java
Cada pattern foi implementado em pastas diferentes:
